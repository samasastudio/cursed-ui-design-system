...
const variantMap: Record<TextVariant, string> = {
  body: 'font-body text-base leading-relaxed text-[var(--cursed-fg)]',
  caption: 'font-body text-sm leading-normal text-[var(--cursed-fg-muted)]',
  label: 'font-body text-xs font-medium uppercase tracking-[0.08em] text-[var(--cursed-fg-muted)]',
